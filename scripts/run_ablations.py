...
TODO: implement once ``scripts/train_energy_model.py`` / ``scripts/evaluate.py``
are functional; this script should just loop over ablation configs and call
those two.
"""

if __name__ == "__main__":
    raise NotImplementedError("Depends on scripts/train_energy_model.py and scripts/evaluate.py.")
